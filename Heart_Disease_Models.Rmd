---
title: "Heart Disease Deaths Models"
author: "Mia Rothberg"
date: "11/24/2021"
...
pollution_mod <- pollution %>%
  mutate(log_heart_disease = log(Diseases.of.heart, base = 10)) %>% 
...
```{r}
pollution_recipe <- recipe(log_heart_disease ~ ., data = pollution_training) %>% 
  step_rm(County,
          Year,
          asthma_er_avg,
          All.causes..total.,
