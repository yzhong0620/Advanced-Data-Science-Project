---
title: "Breast Cancer Surgeries Models"
author: "Mia Rothberg"
date: "11/24/2021"
...
pollution_mod <- pollution %>%
  mutate(log_breast_cancer = log(Breast_Surgery_Ct, base = 10)) %>% 
...
```{r}
pollution_recipe <- recipe(log_breast_cancer ~ ., data = pollution_training) %>% 
  step_rm(County,
          Year,
          All.causes..total.,
          Alzheimer.s.disease,
